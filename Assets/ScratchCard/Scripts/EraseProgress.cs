...
namespace ScratchCardAsset
{
    public class EraseProgress : MonoBehaviour
    {
        ...
        /// </summary>
        ///
        private Action<float> actionCallbackChangeProgress;
        ...
        public void SetActionChangeProgressCallBack(Action<float> actionCallBack)
        {
            actionCallbackChangeProgress += actionCallBack;
        }

        public void RemoveActionChangeProgressCallBack(Action<float> actionCallBack)
        {
            actionCallbackChangeProgress -= actionCallBack;
        }
    }
