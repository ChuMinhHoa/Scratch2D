...
{
    public class ActivityBlock : Activity
    {
        [field: SerializeField] public ActivityBlockContext.UIPresenter UIPresenter { get; private set; }
    ...
    [Serializable]
    public class ActivityBlockContext
    {
